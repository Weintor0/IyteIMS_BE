...
public class Internship extends BaseEntity {
   ...
   @Column(name = "application_form_acceptance", nullable = true)
   @Enumerated(EnumType.STRING)
   private AcceptanceStatus applicationFormAcceptanceStatus;

   @Column(name = "current_transaction_state", nullable = false)
   @Enumerated(EnumType.STRING)
   private TransactionsState currentTransactionState;
   ...
   @Column(name = "summer_practice_report_acceptance_by_firm", nullable = false)
   @Enumerated(EnumType.STRING)
   private AcceptanceStatus summerPracticeReportAcceptanceByFirm;

   @Column(name = "summer_practice_report_acceptance_by_coordinator", nullable = false)
   @Enumerated(EnumType.STRING)
